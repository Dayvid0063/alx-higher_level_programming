#!/usr/bin/python3
"""
unittests for python rectangle

unittest classes:
    TestRectangle_instantiation, _width
    _height, _x
    _y, _order_of_initialization
    _area, _update_args
    _update_kwargs, _to_dictionary
"""
...
class TestRectangle_width(unittest.TestCase):
    """testing initialization of width"""
...
class TestRectangle_height(unittest.TestCase):
    """testing initialization of height"""
...
class TestRectangle_stdout(unittest.TestCase):
    """testing __str__ and viewed method"""

    @staticmethod
    def capture_stdout(rect, method):
        """return txt printed to stdout"""
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
            print(rect)
