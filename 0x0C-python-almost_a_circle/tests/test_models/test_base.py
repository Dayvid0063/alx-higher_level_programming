#!/usr/bin/python3
"""
unittests for python base

unittest classes:
    TestBase_instantiation, _to_json_string
    _save_to_file, _from_json_string
    _create, _load_from_file
    _save_to_file_csv, _load_from_file_csv
"""
