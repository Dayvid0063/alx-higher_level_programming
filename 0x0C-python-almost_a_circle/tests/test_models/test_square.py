#!/usr/bin/python3
"""
unittests for python square

unittest classes:
    TestSquare_instantiation, _size
    _x, _y
    _order_of_initialization, _area
    _stdout, _update_args
...
class TestSquare_stdout(unittest.TestCase):
    """testing __str__ and view methods"""
